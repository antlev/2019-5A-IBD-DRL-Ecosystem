...
if __name__ == "__main__":
    class Bench(Thread):
        ...
        def run(self):
            if self.opponent == "RandomAgent":
                log_dir1 = self.log_dir_root + "RandomRolloutAgent(" + str(self.nb_rollouts) + ")_VS_RandomAgent_" + self.time
                print(log_dir1)
                ...
                log_dir2 = self.log_dir_root + "RandomRolloutAgent(" + str(self.nb_rollouts) + ")_VS_TabularQLearningAgent_" + self.time
                print(log_dir2)
                print(TensorboardTicTacToeRunner(RandomRolloutAgent(self.nb_rollouts,
                                                                     SafeTicTacToeRunner(RandomAgent(),
                                                                     RandomAgent())),
                ...
                log_dir3 = self.log_dir_root + "RandomRolloutAgent(" + str(self.nb_rollouts) + ")_VS_DeepQLearningAgent_" + self.time
                print(log_dir3)
                print(TensorboardTicTacToeRunner(RandomRolloutAgent(self.nb_rollouts,
                                                                     SafeTicTacToeRunner(RandomAgent(),
                                                                     RandomAgent())),
                ...
                log_dir4 = self.log_dir_root + "RandomRolloutAgent(" + str(self.nb_rollouts) + ")_VS_ReinforceClassicAgent_" + self.time
                print(log_dir4)
                print(TensorboardTicTacToeRunner(RandomRolloutAgent(self.nb_rollouts,
                                                                     SafeTicTacToeRunner(RandomAgent(),
                                                                     RandomAgent())),
                ...
                log_dir5 = self.log_dir_root + "RandomRolloutAgent(" + str(self.nb_rollouts) + ")_VS_ReinforceClassicWithMultipleTrajectoriesAgent_" + self.time
                print(log_dir5)
                print(TensorboardTicTacToeRunner(RandomRolloutAgent(self.nb_rollouts,
                                                                     SafeTicTacToeRunner(RandomAgent(),
                                                                     RandomAgent())),
                ...
                log_dir6 = self.log_dir_root + "RandomRolloutAgent(" + str(self.nb_rollouts) + ")_VS_PPOWithMultipleTrajectoriesMultiOutputsAgent_" + self.time
                print(log_dir6)
                print(TensorboardTicTacToeRunner(RandomRolloutAgent(self.nb_rollouts,
                                                                     SafeTicTacToeRunner(RandomAgent(),
                                                                     RandomAgent())),
                ...
                log_dir7 = self.log_dir_root + "RandomRolloutAgent(" + str(self.nb_rollouts) + ")_VS_MOISMCTSWithRandomRolloutsAgent_" + self.time
                print(log_dir7)
                print(TensorboardTicTacToeRunner(RandomRolloutAgent(self.nb_rollouts,
                                                                     SafeTicTacToeRunner(RandomAgent(),
                                                                     RandomAgent())),
                                                 RandomRolloutAgent(self.nb_rollouts,
                                                                     SafeTicTacToeRunner(RandomAgent(),
                                                                                         RandomAgent())),
                                                 log_and_reset_score_history_threshold=10000,
                                                 log_dir=log_dir7).run(1000000000))
            elif self.opponent == "MOISMCTSWithRandomRolloutsExpertThenApprenticeAgent":
                log_dir8 = self.log_dir_root + "RandomRolloutAgent(" + str(self.nb_rollouts) + ")_VS_MOISMCTSWithRandomRolloutsExpertThenApprenticeAgent_" + self.time
                print(log_dir8)
                print(TensorboardTicTacToeRunner(RandomRolloutAgent(self.nb_rollouts,
                                                                     SafeTicTacToeRunner(RandomAgent(),
                                                                     RandomAgent())),
                ...
                log_dir9 = self.log_dir_root + "RandomRolloutAgent(" + str(self.nb_rollouts) + ")_VS_MOISMCTSWithValueNetworkAgent_" + self.time
                print(log_dir9)
                print(TensorboardTicTacToeRunner(RandomRolloutAgent(self.nb_rollouts,
                                                                     SafeTicTacToeRunner(RandomAgent(),
                                                                     RandomAgent())),
                ...
                log_dir10 = self.log_dir_root + "RandomRolloutAgent(" + str(self.nb_rollouts) + ")_VS_DoubleQLearningAgent_" + self.time
                print(log_dir10)
                print(TensorboardTicTacToeRunner(RandomRolloutAgent(self.nb_rollouts,
                                                                     SafeTicTacToeRunner(RandomAgent(),
                                                                     RandomAgent())),
                ...
                nb_rollouts = 3
                log_dir11 = self.log_dir_root + "RandomRolloutAgent(" + str(self.nb_rollouts) + ")_VS_RandomRolloutAgent(" + str(nb_rollouts) + ")_" + self.time
                print(log_dir11)
                print(TensorboardTicTacToeRunner(RandomRolloutAgent(self.nb_rollouts,
                                                                     SafeTicTacToeRunner(RandomAgent(),
                                                                     RandomAgent())),
    ...
    log_dir_root = "./logs/RandomRolloutAgent_vs_all/"
