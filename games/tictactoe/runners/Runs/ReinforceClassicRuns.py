...
if __name__ == "__main__":
    class Bench(Thread):
        ...
        def run(self):
            if self.opponent == "RandomAgent":
                log_dir1 = self.log_dir_root + "ReinforceClassicAgent_VS_RandomAgent_" + self.time
                print(log_dir1)
                print(TensorboardTicTacToeRunner(ReinforceClassicAgent(9, 9),
                                                 RandomAgent(),
                                                 log_and_reset_score_history_threshold=10000,
                                                 log_dir=log_dir1).run(100000000))
            elif self.opponent == "TabularQLearningAgent":
                log_dir2 = self.log_dir_root + "ReinforceClassicAgent_VS_TabularQLearningAgent_" + self.time
                print(log_dir2)
                print(TensorboardTicTacToeRunner(ReinforceClassicAgent(9, 9),
                ...
                log_dir3 = self.log_dir_root + "ReinforceClassicAgent_VS_DeepQLearningAgent_" + self.time
                print(log_dir3)
                print(TensorboardTicTacToeRunner(ReinforceClassicAgent(9, 9),
                ...
                log_dir4 = self.log_dir_root + "ReinforceClassicAgent_VS_ReinforceClassicAgent_" + self.time
                print(log_dir4)
                print(TensorboardTicTacToeRunner(ReinforceClassicAgent(9, 9),
                ...
                log_dir5 = self.log_dir_root + "ReinforceClassicAgent_VS_ReinforceClassicWithMultipleTrajectoriesAgent_" + self.time
                print(log_dir5)
                print(TensorboardTicTacToeRunner(ReinforceClassicAgent(9, 9),
                ...
                log_dir6 = self.log_dir_root + "ReinforceClassicAgent_VS_PPOWithMultipleTrajectoriesMultiOutputsAgent_" + self.time
                print(log_dir6)
                print(TensorboardTicTacToeRunner(ReinforceClassicAgent(9, 9),
                ...
                log_dir7 = self.log_dir_root + "ReinforceClassicAgent_VS_MOISMCTSWithRandomRolloutsAgent_" + self.time
                print(log_dir7)
                print(TensorboardTicTacToeRunner(ReinforceClassicAgent(9, 9),
                ...
                log_dir8 = self.log_dir_root + "ReinforceClassicAgent_VS_MOISMCTSWithRandomRolloutsExpertThenApprenticeAgent_" + self.time
                print(log_dir8)
                print(TensorboardTicTacToeRunner(ReinforceClassicAgent(9, 9),
                ...
                log_dir9 = self.log_dir_root + "ReinforceClassicAgent_VS_MOISMCTSWithValueNetworkAgent_" + self.time
                print(log_dir9)
                print(TensorboardTicTacToeRunner(ReinforceClassicAgent(9, 9),
                ...
                log_dir10 = self.log_dir_root + "ReinforceClassicAgent_VS_DoubleQLearningAgent_" + self.time
                print(log_dir10)
                print(TensorboardTicTacToeRunner(ReinforceClassicAgent(9, 9),
                ...
                nb_rollouts = 3
                log_dir11 = self.log_dir_root + "ReinforceClassicAgent_VS_RandomRolloutAgent(" + str(nb_rollouts) + ")_" + self.time
                print(log_dir11)
                print(TensorboardTicTacToeRunner(ReinforceClassicAgent(9, 9),
    ...
    log_dir_root = "./logs/ReinforceClassicAgent_vs_all/"
