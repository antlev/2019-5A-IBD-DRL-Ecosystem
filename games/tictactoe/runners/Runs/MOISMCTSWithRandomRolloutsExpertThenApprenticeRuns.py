...
if __name__ == "__main__":
    class Bench(Thread):
        ...
        def run(self):
            if self.opponent == "RandomAgent":
                ...
                print(log_dir1)
                print(TensorboardTicTacToeRunner(MOISMCTSWithRandomRolloutsExpertThenApprenticeAgent(100,
                ...
                log_dir8 = self.log_dir_root + "MOISMCTSWithRandomRolloutsExpertThenApprenticeAgent_VS_MOISMCTSWithRandomRolloutsExpertThenApprenticeAgent_" + self.time
                print(log_dir8)
                print(TensorboardTicTacToeRunner(MOISMCTSWithRandomRolloutsExpertThenApprenticeAgent(100,
                                                                                 SafeTicTacToeRunner(RandomAgent(),
                                                                                 RandomAgent()),9,9),
    ...
    log_dir_root = "./logs/MOISMCTSWithRandomRolloutsExpertThenApprenticeAgent_vs_all/"
