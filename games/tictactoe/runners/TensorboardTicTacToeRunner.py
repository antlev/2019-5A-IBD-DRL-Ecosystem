...
class TensorboardTicTacToeRunner(GameRunner):
...
if __name__ == "__main__":
    ...
    # log_dir = "./logs/DoubleQLearningAgent_Vs_Random/" + str(time())
    # print(str(log_dir))
    # print(TensorboardTicTacToeRunner(DoubleQLearningAgent(),
    #                                    RandomAgent(),
    #                                  log_and_reset_score_history_threshold=100,
    #                                    log_dir=log_dir).run(1000000))
    #
    # log_dir = "./logs/DoubleDeepQLearningAgent_Vs_Random/" + str(time())
    # print(str(log_dir))
    # print(TensorboardTicTacToeRunner(DoubleDeepQLearningAgent(9,9),
    #                                    RandomAgent(),
    #                                  log_and_reset_score_history_threshold=100,
    #                                    log_dir=log_dir).run(1000000))

    # log_dir = "./logs/Random_vs_all/RandomAgent_VS_RandomAgent_" + str(time())
    # print(log_dir)
    # print(TensorboardTicTacToeRunner(RandomAgent(),
    #                                  RandomAgent(),
    #                                  log_and_reset_score_history_threshold=10000,
    #                                  log_dir=log_dir).run(100000000))

    # log_dir = "./logs/Random_vs_all/RandomAgent_VS_RandomRollout(3)_" + str(time())
    # print(log_dir)
    # print(TensorboardTicTacToeRunner(RandomAgent(),
    ...
    #                                  log_dir=log_dir).run(100000000))
    #
    # log_dir = "./logs/Random_vs_all/RandomAgent_VS_TabularQLearningAgent_" + str(time())
    # print(log_dir)
    # print(TensorboardTicTacToeRunner(RandomAgent(),
    ...
    #                                  log_dir=log_dir).run(100000000))
    #
    # log_dir = "./logs/Random_vs_all/RandomAgent_VS_DeepQLearningAgent_" + str(time())
    # print(log_dir)
    # print(TensorboardTicTacToeRunner(RandomAgent(),
    ...
    # log_dir = "./logs/Random_vs_all/RandomAgent_VS_ReinforceClassicAgent_2_" + str(time())
    # print(log_dir)
    # print(TensorboardTicTacToeRunner(RandomAgent(),
    ...
    #                                  log_dir=log_dir).run(100000000))
    #
    # log_dir = "./logs/Random_vs_all/RandomAgent_VS_ReinforceClassicWithMultipleTrajectoriesAgent_" + str(time())
    # print(log_dir)
    # print(TensorboardTicTacToeRunner(RandomAgent(),
    ...
    #                                  log_dir=log_dir).run(100000000))
    #
    # log_dir = "./logs/Random_vs_all/RandomAgent_VS_PPOWithMultipleTrajectoriesMultiOutputsAgent_" + str(time())
    # print(log_dir)
    # print(TensorboardTicTacToeRunner(RandomAgent(),
    ...
    #                                  log_dir=log_dir).run(100000000))
    # #
    # log_dir = "./logs/Random_vs_all/RandomAgent_VS_MOISMCTSWithRandomRolloutsAgent_" + str(time())
    # print(log_dir)
    # print(TensorboardTicTacToeRunner(RandomAgent(),
